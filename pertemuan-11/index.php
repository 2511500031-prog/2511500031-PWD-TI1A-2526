  ...
  <main>
    ...
    <section id="contact">
      ...
      <?php if (!empty($flash_sukses)): ?>
        <div style="padding:10px; margin-bottom:10px backgrond#d4edda; color:#155724; border-radius:6px;">
        </div>
        <?php endif; ?>

        <?php if (!empty($flash_error)): ?>
         <div style="padding:10px; margin-bottom:10px backgrond#f8d7da; color:#721c24; border-radius:6px;" >
          <?= $flash_error; ?>
         </div>
         <?php endif; ?>
